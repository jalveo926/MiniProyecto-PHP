...
<body>
    ...
    <ul>
        <li><a href="index.php?action=problema1">Problema 1: Estadísticas de 5 números positivos</a></li>
        <li><a href="index.php?action=problema2">Problema 2: Suma de 1 a 1000</a></li>
        <li><a href="index.php?action=problema3">Problema 3: Presupuesto del Hospital</a></li>
        <li><a href="index.php?action=problema4">Problema 4: [Por implementar]</a></li>
